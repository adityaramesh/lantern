...
[[message Test_1 {
	...
	local make_definitions = function()
		local m1 = lt.message_definition({name = 'Test'})
		m1:add_field(lt.field_definition{name = 'f_1', type = 'int32'})

		local m2 = lt.message_definition({name = 'Test'})
		m2:add_field(lt.field_definition{name = 'f_1', type = 'int32'})
		m2:add_field(lt.field_definition{name = 'f_2', type = 'int32', required = true})
		m2:add_field(lt.field_definition{name = 'f_3', type = 'int32'})

		local m3 = lt.message_definition({name = 'Test_1'})
		m3:add_field(lt.field_definition{name = 'f_1', type = 'int32'})

		local m3_1 = lt.message_definition({name = 'Test_2'})
		m3_1:add_field(lt.field_definition{name = 'f_1', type = 'int32'})
		m3_1:add_field(lt.field_definition{name = 'f_2', type = 'int32', required = true})
		m3_1:add_field(lt.field_definition{name = 'f_3', type = 'int32'})

		local m3_2 = lt.message_definition({name = 'Test_3', required = true})
		m3_2:add_field(lt.field_definition{name = 'f_1', type = 'int32'})
		m3_2:add_field(lt.field_definition{name = 'f_2', type = 'int32', required = true})
